...
MODEL_PATHS = {
    "Gradient Boosting": "C:\\Users\\mnkmr\\Downloads\\Final Vessel Project\\Gradient Boosting_nautical_mile_final.pkl",
    "Random Forest": "C:\\Users\\mnkmr\\Downloads\\Final Vessel Project\\Random Forest_nautical_mile_final.pkl",
    "Decision Tree": "C:\\Users\\mnkmr\\Downloads\\Final Vessel Project\\Decision Tree_nautical_mile_final.pkl",
    "AdaBoost": "C:\\Users\\mnkmr\\Downloads\\Final Vessel Project\\AdaBoost_nautical_mile_final.pkl"
}
...
def load_saved_artifacts():
    ...
    try:
        with open("C:\\Users\\mnkmr\\Downloads\\Final Vessel Project\\columns_new.json", 'r') as f:
            __data_columns = json.load(f)['data_columns']

        for model_name, model_path in MODEL_PATHS.items():
            with open(model_path, 'rb') as model_file:
                __models[model_name] = pickle.load(model_file)
...
def estimate_fuel_consumption(model_name, airpressure, consumption, totalcylinderoilconsumption, totalcylinderoilspecificconsumption, saileddistance):
    if __models is None or __data_columns is None:
        st.error("Models or data columns are not loaded.")
        return None, None
...
if load_saved_artifacts():
    ...
    if st.sidebar.button("Predict"):
        fuel_per_nautical_mile, total_consumption = estimate_fuel_consumption(
            model_name, airpressure, consumption, totalcylinderoilconsumption, totalcylinderoilspecificconsumption, saileddistance
        )
    ...
    st.error("Artifacts could not be loaded. Please check the file paths.")
